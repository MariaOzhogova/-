...
public class ModelTest {
    ...
    void calculate_phi90_returnsZero() {
        ...
        Model model = Model.builder().intensity0(100).phi(90).build();
    ...
    void calculate_phi45_returnsQuarterIntensity() {
        ...
        Model model = Model.builder().intensity0(100).phi(45).build();
    ...
    void calculate_updatesResultField() {
        ...
        Model model = Model.builder().intensity0(80).phi(60).build();
    ...
    void calculate_zeroIntensity_returnsZero() {
        Model model = Model.builder().intensity0(0).phi(45).build();
    ...
    void calculate_negativeAngle_returnsCorrectValue() {
        ...
        Model modelPos = Model.builder().intensity0(100).phi(30).build();
        Model modelNeg = Model.builder().intensity0(100).phi(-30).build();
    ...
    void calculate_phi180_returnsHalfIntensity() {
        ...
        Model model = Model.builder().intensity0(100).phi(180).build();
    ...
    void calculate_phi360_sameAsPhi0() {
        ...
        Model model = Model.builder().intensity0(100).phi(360).build();
    ...
    void builder_setsFieldsCorrectly() {
        Model model = Model.builder().intensity0(42.5).phi(30).build();
    ...
    void setter_updatesFields() {
        Model model = Model.builder().intensity0(0).phi(0).build();
